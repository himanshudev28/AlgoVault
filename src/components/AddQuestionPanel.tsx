...
export function AddQuestionPanel({ sheetId, existingQuestions, onSaved, onClose }: Props) {
  ...
  const input =
    "w-full rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 px-3 py-2 text-sm outline-none transition-colors placeholder:text-zinc-400 focus:border-lime-400 border-zinc-200 dark:border-zinc-800 dark:bg-zinc-950";
  const btnPrimary =
  ...
  return (
    <div className="rounded-2xl border border-lime-400/40 bg-white dark:bg-zinc-900 p-5 shadow-sm bg-white dark:bg-zinc-900">
      {/* Header */}
      ...
      {/* Tab switcher */}
      <div className="mb-4 flex gap-1 rounded-xl border border-zinc-200 dark:border-zinc-800 p-1 border-zinc-200 dark:border-zinc-800">
      ...
      {tab === "url" && (
        <div className="space-y-3">
          ...
          {/* Preview */}
          {preview && (
            <div className="space-y-3 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50 p-4 border-zinc-200 dark:border-zinc-800 dark:bg-zinc-950/60">
              <div className="flex flex-wrap items-start gap-2">
                <span className="rounded-md border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 px-1.5 py-0.5 text-[11px] font-medium border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900">
                ...
                {preview.tags.slice(0, 4).map((t) => (
                  <span key={t} className="rounded-md bg-zinc-200/60 px-1.5 py-0.5 text-[11px] text-zinc-600 bg-zinc-100 dark:bg-zinc-800 dark:text-zinc-400">
                    {t}
                  </span>
                ))}
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <div className="flex-1">
                    ...
                    <select
                      className="w-full rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 px-2.5 py-2 text-sm outline-none focus:border-lime-400 border-zinc-200 dark:border-zinc-800 dark:bg-zinc-950"
                      value={merged.topic}
                  ...
                  <div>
                    ...
                    <select
                      className="rounded-xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 px-2.5 py-2 text-sm outline-none focus:border-lime-400 border-zinc-200 dark:border-zinc-800 dark:bg-zinc-950"
                      value={merged.tag}
              ...
              {preview.description && (
                <details className="rounded-lg border border-zinc-200 dark:border-zinc-800">
                  ...
                  <div
                    className="prose-problem max-h-52 overflow-y-auto border-t border-zinc-200 dark:border-zinc-800 px-3 py-2 border-zinc-200 dark:border-zinc-800"
