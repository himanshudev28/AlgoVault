...
const TAG_COLORS: Record<string, string> = {
  ...
  "easy+": "bg-emerald-500/10 text-emerald-300 border border-emerald-500/15",
    ...
    <div className="min-h-screen bg-zinc-950 text-zinc-100 font-sans">
      ...
      <header className="sticky top-0 z-50 border-b border-zinc-800/60 bg-zinc-950/80 backdrop-blur-xl">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          <Link href="/" className="flex items-center gap-2.5 group">
            <div className="flex size-8 items-center justify-center rounded-lg bg-linear-to-br from-emerald-500 to-teal-600 shadow-lg shadow-emerald-500/20 group-hover:shadow-emerald-500/30 transition-shadow">
            ...
            <span className="text-lg font-bold tracking-tight">
              Algo<span className="text-emerald-400">Vault</span>
            </span>
          </Link>
          ...
          <div className="flex items-center gap-3">
            <ThemeToggle />
            {authed ? (
              <Link href="/dashboard" className="rounded-xl bg-emerald-500 px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-emerald-500/20 transition-all hover:bg-emerald-400 hover:shadow-emerald-500/30">
                Open app →
              </Link>
            ) : (
              <>
                ...
                <Link href="/sign-up" className="rounded-xl bg-emerald-500 px-4 py-2 text-sm font-semibold text-white shadow-lg shadow-emerald-500/20 transition-all hover:bg-emerald-400">
                  Get started free
                </Link>
              </>
            )}
      ...
      <section className="relative overflow-hidden bg-zinc-950">
        ...
        <div className="relative mx-auto max-w-6xl px-6 pt-20 pb-28 md:pt-28 md:pb-36">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            {/* Left — copy */}
            <div>
              <div className="animate-in mb-6 inline-flex items-center gap-2 rounded-full border border-emerald-500/25 bg-emerald-500/10 px-4 py-1.5 text-xs font-medium text-emerald-400">
              ...
              <div className="animate-in delay-300 mt-8 flex flex-wrap items-center gap-3">
                <Link href={cta} className="glow-emerald-sm rounded-xl bg-emerald-500 px-6 py-3 text-sm font-bold text-white transition-all hover:bg-emerald-400 hover:scale-[1.02]">
                  Start tracking — free
                </Link>
              ...
              <div className="animate-in delay-400 mt-10 flex flex-wrap gap-4">
                {[
                  ...
                  <div key={label} className="flex flex-col">
                    <span className="text-2xl font-black text-zinc-100">{n}<span className="text-emerald-400">+</span></span>
              ...
              <div className="glow-emerald rounded-2xl border border-zinc-800 bg-zinc-900/80 backdrop-blur overflow-hidden shadow-2xl">
                ...
                <div className="divide-y divide-zinc-800/50">
                  {[
                    ...
                    <div key={q.title} className="flex items-center gap-3 px-4 py-2.5">
                      <div className={`flex size-5 shrink-0 items-center justify-center rounded-full text-[10px] font-bold ${q.solved ? "bg-emerald-500/20 text-emerald-400" : "border border-zinc-700 text-zinc-600"}`}>
                        {q.solved ? "✓" : ""}
                      </div>
                ...
                <div className="border-t border-zinc-800 px-4 py-2.5 flex items-center justify-between">
                  ...
                  <div className="h-1.5 flex-1 mx-4 overflow-hidden rounded-full bg-zinc-800">
                    <div className="h-full w-[40%] rounded-full bg-linear-to-r from-emerald-500 to-teal-400" />
                  </div>
                  <span className="text-[11px] text-emerald-400 font-medium">2 due today</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="border-y border-zinc-800/50 bg-zinc-900/30">
        <div className="mx-auto flex max-w-6xl items-center justify-center gap-12 px-6 py-5 flex-wrap">
          {[
            { label: "Easy",    count: totalEasy,   color: "text-emerald-400" },
            { label: "Medium",  count: totalMedium, color: "text-amber-400" },
            { label: "Hard",    count: totalHard,   color: "text-red-400" },
            { label: "Topics",  count: TOPICS.length, color: "text-teal-400" },
      ...
      <section id="features" className="mx-auto max-w-6xl px-6 py-24 md:py-32">
        <div className="grid items-center gap-12 lg:grid-cols-2">
          <div>
            <p className="mb-3 text-sm font-bold tracking-widest text-emerald-500 uppercase">01 — Never Forget</p>
            ...
            <ul className="mt-6 space-y-3">
              {[
                ...
                <li key={s} className="flex items-start gap-2.5 text-sm text-zinc-400">
                  <span className="mt-0.5 size-4 shrink-0 rounded-full bg-emerald-500/20 text-emerald-400 flex items-center justify-center text-[10px]">✓</span>
                  {s}
                </li>
              ))}
            </ul>
            <Link href={cta} className="mt-8 inline-flex items-center gap-2 text-sm font-semibold text-emerald-400 hover:text-emerald-300 transition-colors">
          ...
          <div className="rounded-2xl border border-zinc-800 bg-zinc-900/60 overflow-hidden shadow-xl">
            ...
            <div className="border-t border-zinc-800 px-5 py-3 flex gap-2">
              <div className="flex-1 rounded-lg bg-emerald-500/10 border border-emerald-500/20 py-2 text-center text-xs font-bold text-emerald-400">Good</div>
        ...
        <div className="mx-auto max-w-6xl px-6 py-24 md:py-32">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div className="rounded-2xl border border-zinc-800 bg-zinc-950/80 overflow-hidden shadow-xl order-2 lg:order-1">
              ...
              <div className="p-5 space-y-3">
                <div className="rounded-xl border border-zinc-800 bg-zinc-900 px-4 py-3 text-sm text-zinc-400 leading-relaxed">
                  Think about what data structure gives you <span className="text-emerald-400 font-medium">O(1) lookup</span>. You need to check if a complement exists for each element...
                </div>
                <div className="flex gap-2">
                  {["Hint 1", "Hint 2", "Approach", "Solution"].map((step, i) => (
                    <div key={step} className={`flex-1 rounded-lg py-1.5 text-center text-[10px] font-semibold ${i === 1 ? "bg-emerald-500/20 border border-emerald-500/30 text-emerald-400" : i < 1 ? "bg-zinc-800 text-zinc-400" : "bg-zinc-900 border border-zinc-800 text-zinc-600"}`}>
                      {step}
                    </div>
                  ))}
                </div>
            ...
            <div className="order-1 lg:order-2">
              <p className="mb-3 text-sm font-bold tracking-widest text-emerald-500 uppercase">02 — AI that teaches</p>
              <h2 className="text-3xl font-black tracking-tight md:text-4xl">
                Hints that guide.<br />
      ...
      <section id="sheets" className="mx-auto max-w-6xl px-6 py-24 md:py-32">
        <div className="grid items-start gap-12 lg:grid-cols-2">
          <div>
            <p className="mb-3 text-sm font-bold tracking-widest text-emerald-500 uppercase">03 — Every sheet you love</p>
            <h2 className="text-3xl font-black tracking-tight md:text-4xl">
              Import. Track.<br />
            ...
            <Link href={authed ? "/bhaiya-sheets" : cta} className="mt-8 inline-flex items-center gap-2 text-sm font-semibold text-emerald-400 hover:text-emerald-300 transition-colors">
              Browse all sheets →
            </Link>
          </div>
              ...
              <div key={sheet.id} className="rounded-xl border border-zinc-800 bg-zinc-900/50 p-4 transition-all hover:border-zinc-700 hover:bg-zinc-900/80">
                ...
                <div className="mt-2.5 flex flex-wrap gap-1">
                  {sheet.topics.slice(0, 3).map(t => (
                    <span key={t} className="rounded-md bg-emerald-500/8 px-1.5 py-0.5 text-[10px] text-emerald-500">{t}</span>
                  ))}
                </div>
              </div>
            ))}
          ...
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <div className="rounded-2xl border border-zinc-800 bg-zinc-950/80 overflow-hidden shadow-xl">
              <div className="border-b border-zinc-800 px-5 py-3.5 flex items-center justify-between">
                ...
                <div className="flex gap-2">
                  <span className="rounded-lg bg-emerald-500/15 border border-emerald-500/20 px-2.5 py-1 text-[10px] font-bold text-emerald-400">▶ Play</span>
              ...
              <div className="p-5">
                ...
                <div className="flex items-end gap-1.5 h-24 mb-4">
                  {[64, 34, 25, 12, 22, 11, 90, 45, 78, 56].map((h, i) => (
                    <div
                      ...
                      className={`flex-1 rounded-t-sm transition-all ${i === 0 ? "bg-emerald-500" : i === 1 ? "bg-teal-400" : "bg-zinc-700"}`}
                    />
                  ))}
                </div>
                {/* Step counter */}
                <div className="flex items-center justify-between text-xs text-zinc-500">
                  <span>Step 3 / 45</span>
                  <span className="text-zinc-400">Comparing indices <span className="text-emerald-400 font-mono">0</span> and <span className="text-emerald-400 font-mono">1</span></span>
                </div>
                <div className="mt-3 h-1 rounded-full bg-zinc-800">
                  <div className="h-full w-[7%] rounded-full bg-linear-to-r from-emerald-500 to-teal-400" />
                </div>
              </div>
            </div>
            ...
            {/* Copy */}
            <div>
              <p className="mb-3 text-sm font-bold tracking-widest text-emerald-500 uppercase">04 — See it before you code it</p>
              <h2 className="text-3xl font-black tracking-tight md:text-4xl">
                11 algorithm<br />
              ...
              <Link href={authed ? "/visualizers" : cta} className="mt-8 inline-flex items-center gap-2 text-sm font-semibold text-emerald-400 hover:text-emerald-300 transition-colors">
                Open visualizers →
              </Link>
            </div>
          </div>
      ...
      <section className="mx-auto max-w-6xl px-6 py-24 md:py-32">
        <div className="mb-12 text-center">
          <p className="mb-3 text-sm font-bold tracking-widest text-emerald-500 uppercase">The problem set</p>
          <h2 className="text-3xl font-black tracking-tight md:text-4xl">
        ...
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          {topicStats.map(({ topic, count }) => (
            <Link
              ...
              className="group flex items-center gap-3.5 rounded-xl border border-zinc-800 bg-zinc-900/40 px-4 py-3.5 transition-all hover:border-emerald-500/30 hover:bg-zinc-900/80"
            >
              <div className="flex size-9 shrink-0 items-center justify-center rounded-lg bg-emerald-500/10 border border-emerald-500/15 text-emerald-400 group-hover:bg-emerald-500/15 transition-colors">
      ...
      <section className="relative overflow-hidden border-t border-zinc-800/60">
        ...
        <div className="relative mx-auto max-w-3xl px-6 py-28 text-center md:py-36">
          <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-emerald-500/20 bg-emerald-500/8 px-4 py-1.5 text-xs font-medium text-emerald-400">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            <Link href={cta} className="glow-emerald rounded-xl bg-emerald-500 px-8 py-3.5 text-base font-bold text-white transition-all hover:bg-emerald-400 hover:scale-[1.02]">
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-4">
            ...
            <div className="col-span-2 sm:col-span-1">
              <Link href="/" className="flex items-center gap-2 mb-4">
                ...
                <span className="font-bold">Algo<span className="text-emerald-400">Vault</span></span>
              </Link>
