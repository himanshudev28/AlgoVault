...
export default function MockInterviewPage() {
  ...
  const btn =
    "rounded-xl bg-emerald-500 px-5 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-emerald-600 disabled:opacity-50";
    ...
    return (
      <div className="mx-auto max-w-3xl">
        ...
        <div className={`${card} space-y-6 p-6`}>
          ...
          <div className="flex items-center gap-3 border-t border-zinc-100 pt-5 dark:border-zinc-800/60">
              ...
              <div key={q.id} className={`${card} p-5`}>
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="ml-auto text-xs font-medium text-emerald-500 hover:underline"
                  >
                    Open problem ↗
                  </a>
                </div>
