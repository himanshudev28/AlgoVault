      ...
      {open && (
        <div className="mt-3 space-y-3">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-lime-400 px-4 py-2 text-xs font-semibold text-white transition-colors hover:bg-lime-600 disabled:opacity-50"
          >
            ...
            <div>
              <div className="mb-1 flex items-center gap-2 text-[11px] font-semibold uppercase tracking-wide text-zinc-400">
                ...
                {compileFailed ? (
                  ...
                  <span className="rounded bg-lime-400/15 px-1.5 py-0.5 text-lime-400 normal-case">
                    exit 0
                  </span>
                ) : (
